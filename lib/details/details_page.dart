...
class DetailsPage extends StatelessWidget {
  final SearchCountryResponse searchCountryResponse;

  const DetailsPage({super.key, required this.searchCountryResponse});

  static MaterialPageRoute<DetailsPage> route(
    SearchCountryResponse searchCountryResponse,
  ) =>
      MaterialPageRoute(
        builder: (context) => DetailsPage(searchCountryResponse: searchCountryResponse),
      );
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: DetailsView(searchCountryResponse: searchCountryResponse),
    );
  }
}
...
class DetailsView extends StatefulWidget {
  ...
  const DetailsView({super.key, required this.searchCountryResponse});
...
class _DetailsViewState extends State<DetailsView> {
  ...
  Widget build(BuildContext context) {
    ...
    weatherBloc.add(
      WeatherEventGetCurrentWeatherWithForecastByCountry(
        location: widget.searchCountryResponse.name,
      ),
    );
